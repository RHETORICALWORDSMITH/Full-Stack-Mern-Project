...
const CartCards = () => {
  ...
  return (
    <>
      <span className="text-4xl text-yellow-500 mb-5">{`Total Bill: ${totalBill}$ 💰`}</span>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mb-12 gap-9">
        {boughtItems.map((boughtItem) => {
                ...
                <div className="card w-80 shadow-xl hover:scale-105 duration-200 cursor-pointer bg-white text-black dark:bg-gray-800 dark:text-white">
                  ...
                  <div className="card-body min-h-52">
                    ...
                    <div className="flex flex-col gap-3 mt-4">
                      <p className="min-h-20">{boughtItem.title}</p>
