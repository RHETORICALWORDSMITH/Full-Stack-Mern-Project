...
const Cart = () => {
  ...
  const onSubmit = async (data) => {
    ...
    // the following id is generated by mongodb to distinguish between the similar datas so if multiple users purchased item have
    // the same -id then it would be problematic so delete it here and then after the data is saved in data base
    //mongodb will create a unique id for every item again
          ...
          <div className="w-full md:w-1/2 md:order-1 order-2">
            <div className="space-y-12">
              <h1 className="text-4xl font-bold">
                ...
                <span className="text-purple-500 animate-pulse">Cart!</span>
              </h1>
